...
+ (TOTOResultSet *)getLatestResult {
    NSString *url = APIURL;
    url = [url stringByAppendingString:@"getLatestResult"];
    return [[TOTOResultSet class] getResultAtUrl:url];
}

- (TOTOResultSet *)getPreviousResult {
    NSString *url = APIURL;
    url = [url stringByAppendingString:@"getPrevious/date"];
    NSString *resultDate = [self getResultDate];
    url = [url stringByAppendingString:resultDate];
    return [[TOTOResultSet class] getResultAtUrl:url];
}

- (TOTOResultSet *)getNextResult {
    NSString *url = APIURL;
    url = [url stringByAppendingString:@"getNext/date/"];
...
+ (TOTOResultSet *)getResultForDate:(NSDate *)date {
    ...
    NSString *url = APIURL;
    url = [url stringByAppendingString:@"get/date/"];
